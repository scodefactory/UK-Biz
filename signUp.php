...
?>
    ...
    <div id="page-wrapper">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Employer - Sign Up</h1>
            </div>
               ...
               <div class="col-lg-6">
                <form role="form">
                    <div class="form-group">
                        ...
                        <input class="form-control" name="employerName" id="employerName" placeholder="Enter Employer Name" autofocus>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" placeholder="User Name" name="userName" type="email"  value="">
                    </div>
                    <div class="form-group">
